...
\address{\sLiu, Beng(CompSc), 3036589454, \href{mailto:u3658945@connect.hku.hk}{\texttt{u3658945@connect.hku.hk}}}
%
...
\begin{table}
    ...
    \begin{tabular}{ll}
        ...
        \hyperref[task:i01]{\texttt{I01}} & \dots \\
        \hyperref[task:i02]{\texttt{I02}} & \dots \\
        \hyperref[task:i03]{\texttt{I03}} & \dots \\
        \hyperref[task:i03a]{\texttt{I03A}} & \dots \\
        \hyperref[task:i04]{\texttt{I04}} & \dots \\
        \hyperref[task:i05]{\texttt{I05}} & \dots \\
        \hyperref[task:c01]{\texttt{C01}} & \dots \\
        \hyperref[task:c02]{\texttt{C02}} & \dots \\
        \hyperref[task:c03]{\texttt{C03}} & \dots \\
        \hyperref[task:c04]{\texttt{C04}} & \dots \\
        \bottomrule
    \end{tabular}
\end{table}
